...
import com.caraveo.service.AgendaService;
...
public class ContactosController {
	...
	public Agenda recuperaContactos(@PathVariable("id") int id){
	...
	public String guardarContacto(@RequestBody Agenda contacto){		
		return String.valueOf(service.agregarContacto(contacto));
	}
	
	@PutMapping(value="contactos", consumes=MediaType.APPLICATION_JSON_VALUE)
	public void actualizarContacto(@RequestBody Agenda contacto){		
